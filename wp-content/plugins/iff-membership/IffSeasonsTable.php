 ...
 */
class SeasonTable extends WP_List_Table {
    ...
    function prepare_items() {
       ...
       $sql = "select * from wp_iffmembership_plugin_season" . $whereClause;
       ...
       $data = $wpdb->get_results($sql,ARRAY_A);
        ...
        function usort_reorder($a,$b){
            $orderby = (!empty($_REQUEST['orderby'])) ? $_REQUEST['orderby'] : 'start_date'; //If no sort, default to name
...
function renderPage()
{
    ...
    <div class="wrap">
        ...
        <h2>Seasons <a href="#" class="add-new-h2">Add New</a></h2>        
